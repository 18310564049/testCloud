<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      <uni-forms-item name="username" label="姓名24">
      ...
      <uni-forms-item name="gender" label="性别">
        <uni-data-picker v-model="formData.gender" collection="opendb-nation-china" field="name as text,_id as value"></uni-data-picker>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("username,address,gender,mobile,email,comment,nation_china").get().then((res) => {
